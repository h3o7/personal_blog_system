    ...
    <div class="following-list-page">
        ...
        <div class="user-list" v-loading="loading">
            ...
            <div v-if="followingList.length === 0 && !loading" class="empty-state">
                <el-empty description="暂无关注的用户" :image-size="80" />
            </div>
...
import { following, followUser } from '@/api/user'
...
const fetchFollowingList = async () => {
    loading.value = true
    try {
        console.log('获取关注列表:', { pageNum: currentPage.value, pageSize: pageSize.value })

        const response = await following(currentPage.value, pageSize.value)
